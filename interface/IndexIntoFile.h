  ...
  class IndexIntoFile {
    public:
      ...
      void setNumberOfEvents(EntryNumber_t nevents) const {
        transients_.numberOfEvents_ = nevents;
      }
    ...
    private:
      ...
      void resetEventFinder() const {transients_.eventFinder_.reset();}
      std::vector<EventEntry>& eventEntries() const {return transients_.eventEntries_;}
      std::vector<EventNumber_t>& eventNumbers() const {return transients_.eventNumbers_;}
      void fillRunOrLumiIndexes() const;
      void sortEvents() const;
      void sortEventEntries() const;
      int& previousAddedIndex() const {return transients_.previousAddedIndex_;}
      std::map<IndexRunKey, EntryNumber_t>& runToFirstEntry() const {return transients_.runToFirstEntry_;}
      std::map<IndexRunLumiKey, EntryNumber_t>& lumiToFirstEntry() const {return transients_.lumiToFirstEntry_;}
      EntryNumber_t& beginEvents() const {return transients_.beginEvents_;}
      EntryNumber_t& endEvents() const {return transients_.endEvents_;}
      int& currentIndex() const {return transients_.currentIndex_;}
      RunNumber_t& currentRun() const {return transients_.currentRun_;}
      LuminosityBlockNumber_t& currentLumi() const {return transients_.currentLumi_;}
      std::vector<RunOrLumiIndexes>& runOrLumiIndexes() const {return transients_.runOrLumiIndexes_;}
      size_t numberOfEvents() const {return transients_.numberOfEvents_;}
